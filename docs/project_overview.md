...
- **Контекст запроса**: сеттинг/атмосфера/жанр мира, данные персонажа, текущая локация, компактный реестр известных локаций (`mapDescription` + связи) и до 12 последних реплик истории.
